...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> About Section <?php $__env->endSlot(); ?>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        <?php if($about): ?>
            ...
            <!-- Photo -->
            <?php if($about->photo_path ?? false): ?>
            <div class="px-6 pt-5">
                <img src="<?php echo e($about->photo_url); ?>" alt="About Photo"
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-600 dark:text-slate-400 leading-relaxed"><?php echo e($about->description); ?></p>
                </div>

                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    <div>
                        <p class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Birth Date</p>
                        <p class="text-sm font-medium text-slate-800 dark:text-slate-100"><?php echo e($about->birth_date->format('d F Y')); ?></p>
                    </div>
                    <div>
                        <p class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Location</p>
                        <p class="text-sm font-medium text-slate-800 dark:text-slate-100"><?php echo e($about->location); ?></p>
                    </div>
                    <div>
                        <p class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Email</p>
                        <p class="text-sm font-medium text-slate-800 dark:text-slate-100"><?php echo e($about->email); ?></p>
                    </div>
                    <div>
                        <p class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Phone</p>
                        <p class="text-sm font-medium text-slate-800 dark:text-slate-100"><?php echo e($about->phone); ?></p>
                    </div>
                    <div>
                        <p class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Language</p>
                        <p class="text-sm font-medium text-slate-800 dark:text-slate-100"><?php echo e($about->language); ?></p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php $__currentLoopData = explode(',', $about->hobbies); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hobby): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="px-2.5 py-1 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-400 text-xs font-medium rounded-full"><?php echo e(trim($hobby)); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>

                <?php if($about->cv_path ?? false): ?>
                <div>
                    <a href="<?php echo e($about->cv_url); ?>" target="_blank"
        ...
        <?php else: ?>
            <div class="flex flex-col items-center justify-center py-16 px-6 text-center">
                ...
                <a href="<?php echo e(route('admin.about.create')); ?>"
...
<?php endif; ?>
<?php /**PATH D:\FORTOFOLIO\portfolio-laravel\resources\views/admin/about/index.blade.php ENDPATH**/ ?>