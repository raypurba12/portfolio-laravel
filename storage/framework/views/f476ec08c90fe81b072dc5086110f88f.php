...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Hero Section <?php $__env->endSlot(); ?>
    ...
    <div class="mb-4 flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800/50 rounded-xl px-4 py-3 border border-slate-200 dark:border-slate-700">
        ...
        <span>Background slideshow dikelola di <a href="<?php echo e(route('admin.hero-backgrounds.index')); ?>" class="text-indigo-500 dark:text-indigo-400 font-semibold hover:underline">Hero Backgrounds</a></span>
    </div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        <?php if($hero): ?>
            ...
            <!-- Photo preview -->
            <?php if($hero->photo_path): ?>
            <div class="px-6 pt-5">
                <img src="<?php echo e($hero->photo_url); ?>" alt="Hero Photo"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-0 divide-y md:divide-y-0 md:divide-x divide-slate-200 dark:divide-slate-700 px-6 py-5">
                <div class="space-y-4 md:pr-6">
                    <div>
                        ...
                        <p class="text-sm font-medium text-slate-800 dark:text-slate-100"><?php echo e($hero->name); ?></p>
                    </div>
                    <div>
                        <p class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Title</p>
                        <p class="text-sm font-medium text-slate-800 dark:text-slate-100"><?php echo e($hero->title); ?></p>
                    </div>
                    <div>
                        <p class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Typing Text</p>
                        <p class="text-sm text-slate-600 dark:text-slate-400"><?php echo e($hero->typing_text); ?></p>
                    </div>
                </div>
                <div class="space-y-4 pt-4 md:pt-0 md:pl-6">
                    <div>
                        ...
                        <?php if($hero->github_url): ?>
                            <a href="<?php echo e($hero->github_url); ?>" target="_blank" class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline break-all"><?php echo e($hero->github_url); ?></a>
                        <?php else: ?>
                    ...
                    <div>
                        ...
                        <?php if($hero->linkedin_url): ?>
                            <a href="<?php echo e($hero->linkedin_url); ?>" target="_blank" class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline break-all"><?php echo e($hero->linkedin_url); ?></a>
                        <?php else: ?>
                            <span class="text-sm text-slate-400">—</span>
                        <?php endif; ?>
                    </div>
                    <div>
                        ...
                        <?php if($hero->instagram_url): ?>
                            <a href="<?php echo e($hero->instagram_url); ?>" target="_blank" class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline break-all"><?php echo e($hero->instagram_url); ?></a>
                        <?php else: ?>
                            <span class="text-sm text-slate-400">—</span>
                        <?php endif; ?>
                    </div>
                    <div>
                        ...
                        <?php if($hero->whatsapp_url): ?>
                            <a href="<?php echo e($hero->whatsapp_url); ?>" target="_blank" class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline break-all"><?php echo e($hero->whatsapp_url); ?></a>
                        <?php else: ?>
                            <span class="text-sm text-slate-400">—</span>
                        <?php endif; ?>
                    </div>
        ...
        <?php else: ?>
            ...
            <div class="flex flex-col items-center justify-center py-16 px-6 text-center">
                ...
                <a href="<?php echo e(route('admin.hero.create')); ?>"
...
<?php endif; ?>
<?php /**PATH D:\FORTOFOLIO\portfolio-laravel\resources\views/admin/hero/index.blade.php ENDPATH**/ ?>