...
<head>
    ...
    <title><?php echo e($header ?? ($settings['site_title'] ?? config('app.name', 'Portfolio'))); ?></title>
    <meta property="og:title" content="<?php echo e($header ?? ($settings['site_title'] ?? config('app.name', 'Portfolio'))); ?>">
    <meta name="twitter:title" content="<?php echo e($header ?? ($settings['site_title'] ?? config('app.name', 'Portfolio'))); ?>">
    <?php if(!empty($settings['favicon_path'])): ?>
    <link rel="icon" type="image/x-icon" href="<?php echo e(Storage::url($settings['favicon_path'])); ?>">
    <link rel="apple-touch-icon" href="<?php echo e(Storage::url($settings['favicon_path'])); ?>">
    <?php endif; ?>
    <?php if(!empty($settings['site_description'])): ?>
    <meta name="description" content="<?php echo e($settings['site_description']); ?>">
    <meta property="og:description" content="<?php echo e($settings['site_description']); ?>">
    <meta name="twitter:description" content="<?php echo e($settings['site_description']); ?>">
    <?php endif; ?>
    ...
    <script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','<?php echo e($settings['google_analytics']); ?>');</script>
    <?php endif; ?>
    <style>
...
<header x-data="{ open: false, scrolled: false }"
    ...
    <nav class="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 group">
            ...
            <img src="<?php echo e(Storage::url($settings['logo_path'])); ?>" alt="<?php echo e($settings['site_title'] ?? 'Portfolio'); ?>"
        ...
        <div class="hidden md:flex items-center gap-1">
            <?php $__currentLoopData = ['home' => '#home', 'about' => '#about','services' => '#services','skills' => '#skills', 'projects' => '#projects', 'contact' => '#contact']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $target): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('home').$target); ?>"
    ...
    <div x-show="open"
        ...
        <a href="<?php echo e(route('home')); ?>#home"    @click="open=false" class="block py-2 px-3 text-gray-300 hover:text-purple-400 hover:bg-purple-500/10 rounded-lg transition-all">Home</a>
        <a href="<?php echo e(route('home')); ?>#about"   @click="open=false" class="block py-2 px-3 text-gray-300 hover:text-purple-400 hover:bg-purple-500/10 rounded-lg transition-all">About</a>
        <a href="<?php echo e(route('home')); ?>#services"   @click="open=false" class="block py-2 px-3 text-gray-300 hover:text-purple-400 hover:bg-purple-500/10 rounded-lg transition-all">My services</a>
        <a href="<?php echo e(route('home')); ?>#skills"  @click="open=false" class="block py-2 px-3 text-gray-300 hover:text-purple-400 hover:bg-purple-500/10 rounded-lg transition-all">Skills</a>
        <a href="<?php echo e(route('home')); ?>#projects" @click="open=false" class="block py-2 px-3 text-gray-300 hover:text-purple-400 hover:bg-purple-500/10 rounded-lg transition-all">Projects</a>
        <a href="<?php echo e(route('home')); ?>#contact" @click="open=false" class="block py-2 px-3 text-gray-300 hover:text-purple-400 hover:bg-purple-500/10 rounded-lg transition-all">Contact</a>
    </div>
</header>
...
<footer class="relative bg-gray-950 border-t border-purple-500/20 py-10 overflow-hidden">
    ...
    <div class="container mx-auto px-6 text-center relative z-10">
        <p class="font-orbitron text-sm text-gray-500 tracking-wider">
            &copy; <?php echo e(date('Y')); ?> &mdash; <?php echo e($settings['site_footer'] ?? 'Built with'); ?>
...
<?php /**PATH D:\FORTOFOLIO\portfolio-laravel\resources\views/components/frontend-layout.blade.php ENDPATH**/ ?>