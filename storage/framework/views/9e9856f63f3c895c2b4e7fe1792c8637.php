...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Social Media <?php $__env->endSlot(); ?>
...
<?php endif; ?>
    <div class="flex justify-end mb-4">
        <a href="<?php echo e(route('admin.social-media.create')); ?>" class="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors">+ Add Link</a>
    </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-700/50">
                    ...
                    <tr class="hover:bg-gray-700/30 transition-colors">
                        <td class="py-3">
                            <p class="font-medium text-white capitalize"><?php echo e($social->platform); ?></p>
                            <p class="text-xs text-gray-400"><?php echo e($social->label); ?></p>
                        </td>
                        <td class="py-3">
                            <a href="<?php echo e($social->url); ?>" target="_blank" class="text-purple-400 hover:underline text-xs truncate max-w-xs block"><?php echo e($social->url); ?></a>
                        </td>
                        <td class="py-3 text-center">
                            <span class="px-2 py-0.5 text-xs rounded-full <?php echo e($social->is_active ? 'bg-green-500/20 text-green-400' : 'bg-gray-600 text-gray-400'); ?>">
                                <?php echo e($social->is_active ? 'Active' : 'Inactive'); ?>

                            </span>
                        </td>
                        <td class="py-3 text-center text-gray-400"><?php echo e($social->order); ?></td>
                        <td class="py-3 text-right">
                            <a href="<?php echo e(route('admin.social-media.edit', $social)); ?>" class="text-blue-400 hover:text-blue-300 mr-3">Edit</a>
                            <form action="<?php echo e(route('admin.social-media.destroy', $social)); ?>" method="POST" class="inline">
...
<?php endif; ?>
<?php /**PATH D:\FORTOFOLIO\portfolio-laravel\resources\views/admin/social-media/index.blade.php ENDPATH**/ ?>